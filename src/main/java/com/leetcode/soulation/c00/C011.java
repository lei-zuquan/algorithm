...
public class C011 {
    ...
    public int maxArea(int[] height) {
        ...
        while (start < end) {
            boolean isBig = height[start] > height[end];
            int area = isBig ? height[end] * (end - start) : height[start] * (end - start);
